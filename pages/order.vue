      ...
      <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-cover bg-[url('/img/second-gradient.png')] ring-1 ring-gray-900/10 lg:w-1/2">
            ...
            <h2 class="text-3xl font-bold tracking-tight text-gray-900">Bestelling Installatie</h2>
            <p class="mt-6 text-lg leading-8 text-gray-600">Bedankt voor uw interesse in onze producten/diensten. Om een bestelling te plaatsen, vul alstublieft het onderstaande formulier in met uw gegevens en de details van uw bestelling. Ons team zal uw verzoek beoordelen en u terugkoppelen met een bevestiging en eventuele aanvullende informatie.</p>
            <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div class="flex gap-x-4">
                ...
                <dd><a class="hover:text-gray-900" href="tel:+31 68 123 4567">+31 68 123 4567</a></dd>
              </div>
              <div class="flex gap-x-4">
                <dt class="flex-none">
                  <span class="sr-only">Telephone</span>
                ...
                <dd><a class="hover:text-gray-900" href="mailto:hello@example.com">info@hisolar.nl</a></dd>
              </div>
            </dl>
          </div>
        </div>
        <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
          <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
              <div>
                <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">Voornaam</label>
                <div class="mt-2.5">
              ...
              <div class="sm:col-span-2">
                <label for="phone-number" class="block text-sm font-semibold leading-6 text-gray-900">Telefoonnummer</label>
                <div class="mt-2.5">
            ...
            <div class="mt-8 flex justify-end">
              <button type="submit" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Verstuur Bericht</button>
            </div>
          </div>
        </form>
      </div>
